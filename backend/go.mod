module github.com/RedShawn258/FinTrack/backend
...
replace github.com/quic-go/qpack => github.com/quic-go/qpack v0.5.0

replace golang.org/x/arch => golang.org/x/arch v0.19.0

replace golang.org/x/crypto => golang.org/x/crypto v0.22.0

replace golang.org/x/net => golang.org/x/net v0.22.0

replace golang.org/x/tools => golang.org/x/tools v0.22.0
